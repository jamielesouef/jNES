...
extension CPU {
  func getInstructions(for opcode: UInt8) ->Instruction {
    ...
    let table: [UInt8: Instruction] = [
      0x00: Instruction(address: 0x00, name: "BRK", cycles: 7, bytes: 1, mode: .implied, fn: { self.BRK() }),
      ...
      0x0A: Instruction(address: 0x0A, name: "ASL", cycles: 2, bytes: 1, mode: .accumulator, fn:{ self.ASL(mode: .accumulator)}),
      ...
      0x90: Instruction(address: 0x90, name: "BCC", cycles: 2, bytes: 2, mode: .relative, fn: self.BCC),
      0xB0: Instruction(address: 0xB0, name: "BCS", cycles: 2, bytes: 2, mode: .relative, fn: self.BCS),
      0xF0: Instruction(address: 0xF0, name: "BEQ", cycles: 2, bytes: 2, mode: .relative, fn: self.BEQ),
      ...
      0x30: Instruction(address: 0x30, name: "BMI", cycles: 2, bytes: 2, mode: .implied, fn: self.BMI),
      0xD0: Instruction(address: 0xD0, name: "BNE", cycles: 2, bytes: 2, mode: .implied, fn: self.BNE),
      0x10: Instruction(address: 0x10, name: "BPL", cycles: 2, bytes: 2, mode: .implied, fn: self.BPL),
      0x50: Instruction(address: 0x50, name: "BVC", cycles: 2, bytes: 2, mode: .implied, fn: self.BVC),
      0x70: Instruction(address: 0x70, name: "BVS", cycles: 2, bytes: 2, mode: .implied, fn: self.BVS),
      0x18: Instruction(address: 0x18, name: "CLC", cycles: 2, bytes: 1, mode: .implied, fn: self.CLC),
      0xD8: Instruction(address: 0xD8, name: "CLD", cycles: 2, bytes: 1, mode: .implied, fn: self.CLD),
      0x58: Instruction(address: 0x58, name: "CLI", cycles: 2, bytes: 1, mode: .implied, fn: self.CLI),
      0xB8: Instruction(address: 0xB8, name: "CLV", cycles: 2, bytes: 1, mode: .implied, fn: self.CLV),
      ...
      0xCA: Instruction(address: 0xCA, name: "DEX", cycles: 2, bytes: 1, mode: .implied, fn: self.DEX),
      0x88: Instruction(address: 0x88, name: "DEY", cycles: 2, bytes: 1, mode: .implied, fn: self.DEY),
      ...
      0xE8: Instruction(address: 0xE8, name: "INX", cycles: 2, bytes: 1, mode: .implied, fn: self.INX),
      0xC8: Instruction(address: 0xC8, name: "INY", cycles: 2, bytes: 1, mode: .implied, fn: self.INY),
      0x4C: Instruction(address: 0x4C, name: "JMP", cycles: 3, bytes: 3, mode: .absolute, fn: { self.JMP(mode: .absolute)}),
      0x6C: Instruction(address: 0x6C, name: "JMP", cycles: 5, bytes: 3, mode: .indirect, fn: { self.JMP(mode: .indirect)}),
      0x20: Instruction(address: 0x20, name: "JSR", cycles: 6, bytes: 3, mode: .absolute, fn: self.JSR),
      ...
      0x4A: Instruction(address: 0x4A, name: "LSR", cycles: 2, bytes: 1, mode: .accumulator, fn: { self.LSR(mode: .accumulator) }),
      ...
      0xEA: Instruction(address: 0xEA, name: "NOP", cycles: 2, bytes: 1, mode: .implied, fn: self.NOP),
      ...
      0x48: Instruction(address: 0x48, name: "PHA", cycles: 3, bytes: 1, mode: .implied, fn: self.PHA),
      0x08: Instruction(address: 0x08, name: "PHP", cycles: 3, bytes: 1, mode: .implied, fn: self.PHP),
      0x68: Instruction(address: 0x68, name: "PLA", cycles: 4, bytes: 1, mode: .implied, fn: self.PLA),
      0x28: Instruction(address: 0x28, name: "PLP", cycles: 4, bytes: 1, mode: .implied, fn: self.PLP),
      0x26: Instruction(address: 0x26, name: "ROL", cycles: 5, bytes: 2, mode: .zeroPage, fn: { self.ROL(mode: .zeroPage)}),
      0x2A: Instruction(address: 0x2A, name: "ROL", cycles: 2, bytes: 1, mode: .accumulator, fn: { self.ROL(mode: .accumulator)}),
      ...
      0x6A: Instruction(address: 0x6A, name: "ROR", cycles: 2, bytes: 1, mode: .accumulator, fn: { self.ROR(mode: .accumulator)}),
      ...
      0x40: Instruction(address: 0x40, name: "RTI", cycles: 6, bytes: 1, mode: .implied, fn: self.RTI),
      0x60: Instruction(address: 0x60, name: "RTS", cycles: 6, bytes: 1, mode: .implied, fn: self.RTS),
      ...
      0x38: Instruction(address: 0x38, name: "SEC", cycles: 2, bytes: 1, mode: .implied, fn: self.SEC),
      0xF8: Instruction(address: 0xF8, name: "SED", cycles: 2, bytes: 1, mode: .implied, fn: self.SED),
      0x78: Instruction(address: 0x78, name: "SEI", cycles: 2, bytes: 1, mode: .implied, fn: self.SEI),
      ...
      0xAA: Instruction(address: 0xAA, name: "TAX", cycles: 2, bytes: 1, mode: .implied, fn: self.TAX),
      0xA8: Instruction(address: 0xA8, name: "TAY", cycles: 2, bytes: 1, mode: .implied, fn: self.TAY),
      0xBA: Instruction(address: 0xBA, name: "TSX", cycles: 2, bytes: 1, mode: .implied, fn: self.TSX),
      0x8A: Instruction(address: 0x8A, name: "TXA", cycles: 2, bytes: 1, mode: .implied, fn: self.TXA),
      0x9A: Instruction(address: 0x9A, name: "TXS", cycles: 2, bytes: 1, mode: .implied, fn: self.TXS),
      0x98: Instruction(address: 0x98, name: "TYA", cycles: 2, bytes: 1, mode: .implied, fn: self.TYA),
      ...
      0x02: Instruction(address: 0x02, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x12: Instruction(address: 0x12, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x22: Instruction(address: 0x22, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x32: Instruction(address: 0x32, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x42: Instruction(address: 0x42, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x52: Instruction(address: 0x52, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x62: Instruction(address: 0x62, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x72: Instruction(address: 0x72, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0x92: Instruction(address: 0x92, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0xB2: Instruction(address: 0xB2, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
      0xD2: Instruction(address: 0xD2, name: "KIL", cycles: 1, bytes: 1, mode: .implied, fn: self.KIL),
