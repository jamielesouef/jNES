...
extension CPU {
  func getInstructions(for opcode: UInt8) ->Instruction {
    ...
    case 0x04: Instruction(address: 0x04, name: "*NOP", cycles: 3, bytes: 2, mode: .zeroPage, fn: self.NOP)
    case 0x14: Instruction(address: 0x14, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: self.NOP)
    case 0x34: Instruction(address: 0x34, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: self.NOP)
    case 0x44: Instruction(address: 0x44, name: "*NOP", cycles: 3, bytes: 2, mode: .zeroPage, fn: self.NOP)
    case 0x54: Instruction(address: 0x54, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: self.NOP)
    case 0x64: Instruction(address: 0x64, name: "*NOP", cycles: 3, bytes: 2, mode: .zeroPage, fn: self.NOP)
    case 0x74: Instruction(address: 0x74, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: self.NOP)
    case 0x80: Instruction(address: 0x80, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: self.NOP)
    case 0x82: Instruction(address: 0x82, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: self.NOP)
    case 0x89: Instruction(address: 0x89, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: self.NOP)
    case 0xC2: Instruction(address: 0xC2, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: self.NOP)
    case 0xD4: Instruction(address: 0xD4, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: self.NOP)
    case 0xE2: Instruction(address: 0xE2, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: self.NOP)
    case 0xF4: Instruction(address: 0xF4, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: self.NOP)
    ...
    case 0x0C: Instruction(address: 0x0C, name: "*NOP", cycles: 4, bytes: 3, mode: .absolute, fn: self.NOP)
    case 0x1C: Instruction(address: 0x1C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: self.NOP)
    case 0x3C: Instruction(address: 0x3C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: self.NOP)
    case 0x5C: Instruction(address: 0x5C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: self.NOP)
    case 0x7C: Instruction(address: 0x7C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: self.NOP)
    case 0xDC: Instruction(address: 0xDC, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: self.NOP)
    case 0xFC: Instruction(address: 0xFC, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: self.NOP)
