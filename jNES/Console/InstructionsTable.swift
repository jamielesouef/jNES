...
extension CPU {
  ...
  func getInstructions(for opcode: UInt8) -> Instruction {
    ...
    case 0x90: Instruction(address: 0x90, name: "BCC", cycles: 2, bytes: 2, mode: .none, fn: BCC)
    case 0xB0: Instruction(address: 0xB0, name: "BCS", cycles: 2, bytes: 2, mode: .none, fn: BCS)
    case 0xF0: Instruction(address: 0xF0, name: "BEQ", cycles: 2, bytes: 2, mode: .none, fn: BEQ)
    ...
    case 0x30: Instruction(address: 0x30, name: "BMI", cycles: 2, bytes: 2, mode: .none, fn: BMI)
    case 0xD0: Instruction(address: 0xD0, name: "BNE", cycles: 2, bytes: 2, mode: .none, fn: BNE)
    case 0x10: Instruction(address: 0x10, name: "BPL", cycles: 2, bytes: 2, mode: .none, fn: BPL)
    case 0x50: Instruction(address: 0x50, name: "BVC", cycles: 2, bytes: 2, mode: .none, fn: BVC)
    case 0x70: Instruction(address: 0x70, name: "BVS", cycles: 2, bytes: 2, mode: .none, fn: BVS)
    case 0x18: Instruction(address: 0x18, name: "CLC", cycles: 2, bytes: 1, mode: .none, fn: CLC)
    case 0xD8: Instruction(address: 0xD8, name: "CLD", cycles: 2, bytes: 1, mode: .none, fn: CLD)
    case 0x58: Instruction(address: 0x58, name: "CLI", cycles: 2, bytes: 1, mode: .none, fn: CLI)
    case 0xB8: Instruction(address: 0xB8, name: "CLV", cycles: 2, bytes: 1, mode: .none, fn: CLV)
    ...
    case 0xCA: Instruction(address: 0xCA, name: "DEX", cycles: 2, bytes: 1, mode: .none, fn: DEX)
    case 0x88: Instruction(address: 0x88, name: "DEY", cycles: 2, bytes: 1, mode: .none, fn: DEY)
    ...
    case 0xE8: Instruction(address: 0xE8, name: "INX", cycles: 2, bytes: 1, mode: .none, fn: INX)
    case 0xC8: Instruction(address: 0xC8, name: "INY", cycles: 2, bytes: 1, mode: .none, fn: INY)
    ...
    case 0x20: Instruction(address: 0x20, name: "JSR", cycles: 6, bytes: 3, mode: .none, fn: JSR)
    ...
    case 0xEA: Instruction(address: 0xEA, name: "NOP", cycles: 2, bytes: 1, mode: .none, fn: NOP)
    ...
    case 0x48: Instruction(address: 0x48, name: "PHA", cycles: 3, bytes: 1, mode: .none, fn: PHA)
    case 0x08: Instruction(address: 0x08, name: "PHP", cycles: 3, bytes: 1, mode: .none, fn: PHP)
    case 0x68: Instruction(address: 0x68, name: "PLA", cycles: 4, bytes: 1, mode: .none, fn: PLA)
    case 0x28: Instruction(address: 0x28, name: "PLP", cycles: 4, bytes: 1, mode: .none, fn: PLP)
    ...
    case 0x40: Instruction(address: 0x40, name: "RTI", cycles: 6, bytes: 1, mode: .none, fn: RTI)
    case 0x60: Instruction(address: 0x60, name: "RTS", cycles: 6, bytes: 1, mode: .none, fn: RTS)
    ...
    case 0x38: Instruction(address: 0x38, name: "SEC", cycles: 2, bytes: 1, mode: .none, fn: SEC)
    case 0xF8: Instruction(address: 0xF8, name: "SED", cycles: 2, bytes: 1, mode: .none, fn: SED)
    case 0x78: Instruction(address: 0x78, name: "SEI", cycles: 2, bytes: 1, mode: .none, fn: SEI)
    ...
    case 0xAA: Instruction(address: 0xAA, name: "TAX", cycles: 2, bytes: 1, mode: .none, fn: TAX)
    case 0xA8: Instruction(address: 0xA8, name: "TAY", cycles: 2, bytes: 1, mode: .none, fn: TAY)
    case 0xBA: Instruction(address: 0xBA, name: "TSX", cycles: 2, bytes: 1, mode: .none, fn: TSX)
    case 0x8A: Instruction(address: 0x8A, name: "TXA", cycles: 2, bytes: 1, mode: .none, fn: TXA)
    case 0x9A: Instruction(address: 0x9A, name: "TXS", cycles: 2, bytes: 1, mode: .none, fn: TXS)
    case 0x98: Instruction(address: 0x98, name: "TYA", cycles: 2, bytes: 1, mode: .none, fn: TYA)
    case 0x87: Instruction(address: 0x87, name: "*SAX", cycles: 3, bytes: 2, mode: .zeroPage, fn: { self.SAX(mode: .zeroPage) })
    case 0x97: Instruction(address: 0x97, name: "*SAX", cycles: 4, bytes: 2, mode: .zeroPageY, fn: { self.SAX(mode: .zeroPageY) })
    case 0x83: Instruction(address: 0x83, name: "*SAX", cycles: 6, bytes: 2, mode: .indirectX, fn: { self.SAX(mode: .indirectX) })
    case 0x8F: Instruction(address: 0x8F, name: "*SAX", cycles: 4, bytes: 3, mode: .absolute, fn: { self.SAX(mode: .absolute) })
    ...
    case 0x04: Instruction(address: 0x04, name: "*NOP", cycles: 3, bytes: 2, mode: .zeroPage, fn: NOP)
    case 0x14: Instruction(address: 0x14, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: NOP)
    case 0x34: Instruction(address: 0x34, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: NOP)
    case 0x44: Instruction(address: 0x44, name: "*NOP", cycles: 3, bytes: 2, mode: .zeroPage, fn: NOP)
    case 0x54: Instruction(address: 0x54, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: NOP)
    case 0x64: Instruction(address: 0x64, name: "*NOP", cycles: 3, bytes: 2, mode: .zeroPage, fn: NOP)
    case 0x74: Instruction(address: 0x74, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: NOP)
    case 0x80: Instruction(address: 0x80, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: NOP)
    case 0x82: Instruction(address: 0x82, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: NOP)
    case 0x89: Instruction(address: 0x89, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: NOP)
    case 0xC2: Instruction(address: 0xC2, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: NOP)
    case 0xD4: Instruction(address: 0xD4, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: NOP)
    case 0xE2: Instruction(address: 0xE2, name: "*NOP", cycles: 2, bytes: 2, mode: .immediate, fn: NOP)
    case 0xF4: Instruction(address: 0xF4, name: "*NOP", cycles: 4, bytes: 2, mode: .zeroPageX, fn: NOP)
    case 0xE7: Instruction(address: 0xE7, name: "*ISB", cycles: 5, bytes: 2, mode: .zeroPage, fn: { self.ISB(mode: .zeroPage) })
    case 0xF7: Instruction(address: 0xF7, name: "*ISB", cycles: 6, bytes: 2, mode: .zeroPageX, fn: { self.ISB(mode: .zeroPageX) })
    case 0xEF: Instruction(address: 0xEF, name: "*ISB", cycles: 6, bytes: 3, mode: .absolute, fn: { self.ISB(mode: .absolute) })
    case 0xFF: Instruction(address: 0xFF, name: "*ISB", cycles: 7, bytes: 3, mode: .absoluteX, fn: { self.ISB(mode: .absoluteX) })
    case 0xFB: Instruction(address: 0xFB, name: "*ISB", cycles: 7, bytes: 3, mode: .absoluteY, fn: { self.ISB(mode: .absoluteY) })
    case 0xE3: Instruction(address: 0xE3, name: "*ISB", cycles: 8, bytes: 2, mode: .indirectX, fn: { self.ISB(mode: .indirectX) })
    case 0xF3: Instruction(address: 0xF3, name: "*ISB", cycles: 8, bytes: 2, mode: .indirectY, fn: { self.ISB(mode: .indirectY) })
    ...
    case 0x1A: Instruction(address: 0x1A, name: "*NOP", cycles: 2, bytes: 1, mode: .implied, fn: NOP)
    case 0x3A: Instruction(address: 0x3A, name: "*NOP", cycles: 2, bytes: 1, mode: .implied, fn: NOP)
    case 0x5A: Instruction(address: 0x5A, name: "*NOP", cycles: 2, bytes: 1, mode: .implied, fn: NOP)
    case 0x7A: Instruction(address: 0x7A, name: "*NOP", cycles: 2, bytes: 1, mode: .implied, fn: NOP)
    case 0xDA: Instruction(address: 0xDA, name: "*NOP", cycles: 2, bytes: 1, mode: .implied, fn: NOP)
    case 0xFA: Instruction(address: 0xFA, name: "*NOP", cycles: 2, bytes: 1, mode: .implied, fn: NOP)
    ...
    case 0x0C: Instruction(address: 0x0C, name: "*NOP", cycles: 4, bytes: 3, mode: .absolute, fn: NOP)
    case 0x1C: Instruction(address: 0x1C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: NOP)
    case 0x3C: Instruction(address: 0x3C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: NOP)
    case 0x5C: Instruction(address: 0x5C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: NOP)
    case 0x7C: Instruction(address: 0x7C, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: NOP)
    case 0xDC: Instruction(address: 0xDC, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: NOP)
    case 0xFC: Instruction(address: 0xFC, name: "*NOP", cycles: 4, bytes: 3, mode: .absoluteX, fn: NOP)
