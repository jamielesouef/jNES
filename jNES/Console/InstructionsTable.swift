...
extension CPU {
  func getInstructions(for opcode: UInt8) ->Instruction {
    ...
    let table: [UInt8: Instruction] = [
      ...
      0x4A: Instruction(address: 0x4A, name: "LSR", cycles: 2, bytes: 1, mode: .none, fn: { self.LSR(mode: .none) }),
      ...
      0x2A: Instruction(address: 0x2A, name: "ROL", cycles: 2, bytes: 1, mode: .none, fn: { self.ROL(mode: .none)}),
      ...
      0x6A: Instruction(address: 0x6A, name: "ROR", cycles: 2, bytes: 1, mode: .none, fn: { self.ROR(mode: .none)}),
