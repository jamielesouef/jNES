...
private let NES_TAG: [UInt8] = [0x4E, 0x45, 0x53, 0x1A]
private let PRG_ROM_BANK_SIZE: UInt16 = 16384
private let CHR_ROM_BANK_SIZE: UInt16 = 8192
...
struct Rom {
  ...
  init(data: [UInt8]) throws {
    ...
    prgRom = Array(data[prgStart ..< prgEnd])
    chrRom = Array(data[chrStart ..< chrEnd])
  }
}
